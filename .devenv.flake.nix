{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/ddrhckrzz/CodingEnv/CMSC121";
  project_input_ref = "path:/home/ddrhckrzz/CodingEnv/CMSC121";
  devenv_dotfile = "/home/ddrhckrzz/CodingEnv/CMSC121/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-2fc04a6";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "ddrhckrzz-nixos";
  username = "ddrhckrzz";
  git_root = "/home/ddrhckrzz/CodingEnv/CMSC121";
  secretspec = null;
};
    in
    {
